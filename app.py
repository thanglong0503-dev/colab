...
# Khung Chatbot
user_question = st.text_input("Ngài muốn hỏi gì về danh mục trên? (VD: Đánh giá giúp mã HPG)")
    ...
    if user_question:
        with st.spinner("AI đang phân tích..."):
            try:
                ...
                sys_prompt = f"Bạn là Giám đốc Quỹ. Dữ liệu: {data_context}. Trả lời câu hỏi người dùng DỰA TRÊN SỐ LIỆU NÀY."
