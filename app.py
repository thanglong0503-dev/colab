...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "assistant", "content": "Fincept AI đã sẵn sàng. Ngài cần phân tích định lượng mã cổ phiếu nào?"}
    ]
...
if prompt := st.chat_input("Nhập mã chứng khoán (Ví dụ: HPG, SSI...)..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("Đang quét dữ liệu RS_DATA..."):
            try:
                ...
                sys_prompt = "Bạn là AI Analyst tại Mirae Asset. Trả lời bằng dữ liệu CSV, giọng điệu chuyên nghiệp, trích dẫn số liệu cụ thể."
